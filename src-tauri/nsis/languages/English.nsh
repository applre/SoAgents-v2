; English language file for SoAgents NSIS Installer
...
LangString alreadyInstalledLong ${LANG_ENGLISH} "SoAgents $R5 is already installed.$\n$\nYou can choose to reinstall or uninstall."
...
LangString olderOrUnknownVersionInstalled ${LANG_ENGLISH} "SoAgents $R5 is already installed. You are about to install SoAgents ${VERSION}.$\n$\nYou can proceed with the upgrade directly."
